...
import {
	...
	__facade_invoke__,
	__facade_register__,
} from "/workspaces/nextjs_learn/node_modules/wrangler/templates/middleware/common.ts";

import worker from "/workspaces/nextjs_learn/.wrangler/tmp/bundle-6LzZPq/middleware-insertion-facade.js";

// We need to preserve all of the exports from the worker
export * from "/workspaces/nextjs_learn/.wrangler/tmp/bundle-6LzZPq/middleware-insertion-facade.js";
